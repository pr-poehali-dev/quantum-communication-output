  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Мы боялись, что минимализм окажется холодным. Но получилось наоборот — дом стал уютнее, чем был с мебелью из
          трёх квартир. Wabi Studio поняли нас с первого разговора.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widests uppercase text-primary-foreground/80">Екатерина и Дмитрий Соколовы</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Квартира 180 м² · Санкт-Петербург</p>
        </div>
      </div>
    </section>
  )
