      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4">
            <p className="font-serif text-2xl tracking-wide text-foreground mb-4">Wabi Studio</p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Дизайн интерьеров в стиле Japandi. Москва и Санкт-Петербург.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-muted-foreground">Каждый интерьер создаётся с намерением</p>
        </div>
      </div>
    </footer>
  )
