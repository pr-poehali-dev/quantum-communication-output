  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Интерьеры,
          <span className="block text-sage">которые живут</span>
        </h1>
        ...
        >
          Создаём жилые пространства, где каждая деталь служит жизни, а не витрине. Философия Japandi — минимализм, тепло и долговечность.
        </p>
