...
const steps = [
  {
    number: "01",
    title: "Встреча и погружение",
    description:
      "Знакомимся с вами, вашим домом и образом жизни. Задаём вопросы, которые другие не задают — о ритмах, привычках, ощущениях, которых пока нет, но хочется.",
  },
  {
    number: "02",
    title: "Концепция",
    description:
      "Разрабатываем планировочное решение, мудборды и палитру. Вы видите будущий интерьер до начала работ — и вносите правки без лишних затрат.",
  },
  {
    number: "03",
    title: "Рабочий проект",
    description:
      "Полный пакет документации для строителей: чертежи, спецификации, ведомости материалов. Ничего не остаётся на усмотрение подрядчика.",
  },
  {
    number: "04",
    title: "Авторский надзор",
    description:
      "Присутствуем на объекте на ключевых этапах, контролируем качество и решаем нестандартные ситуации. Вы получаете именно то, что задумали.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Хороший дизайн — это не скорость, а точность. Четыре шага, которые ведут от первой встречи
                до ключей от готового дома — вашего, настоящего.
              </p>
            </div>
          </div>
